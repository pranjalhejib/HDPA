...
class Classification:
    ...
    def __init__(self):
        ...
        self.ds = pd.read_csv("D:/LearnCode/Django/HealthDiseasePrediction/HDPA/HeartApp/data/heart.csv")

        self.dsl = pd.read_csv("D:/LearnCode/Django/HealthDiseasePrediction/HDPA/HeartApp/data/heart.csv")
